...
public class Teclado {
	...
	public static char leerChar(){
		...
		do {
			cadena = teclado.next();
			if (cadena.length()>1)
				System.out.print("- Introduzca sólo un caracter: ");
			else
		...
		do{
			...
			if (cadena.length()>1)
				...
				if (cadena.matches(patron)){
					...
					System.out.print("El caracter no cumple el patrón: ");
					repetir = true;
				}
