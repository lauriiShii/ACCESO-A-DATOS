...
public class Main {
	...
	public static void main(String[] args) {
		...
		Query cons = session.createQuery("SELECT h.curso.id.codOe, h.curso.id.codCurso, h.tramohorario.dia, h.asignatura.nombre, count(*) FROM Horario h Group by 1,3,4 HAVING count(*)>1 ORDER BY 1,2,3,4");
