...
public class HorarioId implements java.io.Serializable {
	...
	public HorarioId(String codOe, String codCurso, String codAsignatura, String codTramo) {
		this.codOe = codOe;
	...
	public boolean equals(Object other) {
		...
		return ((this.getCodOe() == castOther.getCodOe()) || (this.getCodOe() != null && castOther.getCodOe() != null
				...
				&& ((this.getCodAsignatura() == castOther.getCodAsignatura())
						|| (this.getCodAsignatura() != null && castOther.getCodAsignatura() != null
								&& this.getCodAsignatura().equals(castOther.getCodAsignatura())))
